...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Will duplicate any specified variables and shift them
% Creates new fields in the trial_data struct of format:
%       [ORIGINAL_VAR_NAME '_shifted']
...
% idx fields to reflect that. Must shift back in time.
%
% INPUTS:
